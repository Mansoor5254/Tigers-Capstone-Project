...
@Bank
  Scenario: Add and Remove a Mac book from Cart
    ...
    Then User should see a message 'Success: You have added MacBookto your shopping cart!'
...
@Bank
  Scenario: Product Comparison
    ...
    Then User should get a message 'Success: You have added MacBook Air to your product comparison!'
